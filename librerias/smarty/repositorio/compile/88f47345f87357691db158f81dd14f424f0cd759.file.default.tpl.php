<?php /* Smarty version Smarty-3.1.11, created on 2017-01-03 12:20:48
		...
		<aside class="main-sidebar">
			...
			<!-- sidebar menu: : style can be found in sidebar.less -->
				<ul class="sidebar-menu">
					...
					<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['PAGE']->value['usuario']->getIdTipo()==1){?>
					<li class="<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['modulo'],array('productos','terminales','almacenes'))){?>active<?php }?> treeview">
						<a href="#">
							<span>Catálogos</span> <i class="fa fa-angle-left pull-right"></i>
						</a>
						<ul class="treeview-menu">
							<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='almacenes'){?>class="active"<?php }?>><a href="almacenes"><i class="fa fa-industry"></i> Almacenes</a></li>
							<!--<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='terminales'){?>class="active"<?php }?>><a href="terminales"><i class="fa fa-terminal"></i> Terminales</a></li>-->
							<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='productos'){?>class="active"<?php }?>><a href="productos"><i class="fa fa-product-hunt"></i> Productos</a></li>
						</ul>
					</li>
					<?php }?>
					<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['usuario']->getIdTipo(),array(1,2))){?>
					<li class="<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['modulo'],array('libreta'))){?>active<?php }?> treeview">
						<a href="#">
							<span>Tienda</span> <i class="fa fa-angle-left pull-right"></i>
						</a>
						<ul class="treeview-menu">
							<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='libreta'){?>class="active"<?php }?>><a href="libreta"><i class="fa fa-balance-scale"></i> Libreta de ventas</a></li>
						</ul>
					</li>
					<?php }?>
				</ul>
