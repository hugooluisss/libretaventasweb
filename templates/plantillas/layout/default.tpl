		...
		<aside class="main-sidebar">
			...
			<!-- sidebar menu: : style can be found in sidebar.less -->
				<ul class="sidebar-menu">
					...
					{/if}
					{if $PAGE.usuario->getIdTipo() eq 1}
					<li class="{if in_array($PAGE.modulo, array('productos', 'terminales', 'almacenes'))}active{/if} treeview">
						<a href="#">
							<span>Catálogos</span> <i class="fa fa-angle-left pull-right"></i>
						</a>
						<ul class="treeview-menu">
							<li {if $PAGE.modulo eq 'almacenes'}class="active"{/if}><a href="almacenes"><i class="fa fa-industry"></i> Almacenes</a></li>
							<!--<li {if $PAGE.modulo eq 'terminales'}class="active"{/if}><a href="terminales"><i class="fa fa-terminal"></i> Terminales</a></li>-->
							<li {if $PAGE.modulo eq 'productos'}class="active"{/if}><a href="productos"><i class="fa fa-product-hunt"></i> Productos</a></li>
						</ul>
					</li>
					{/if}
					{if in_array($PAGE.usuario->getIdTipo(), array(1, 2))}
					<li class="{if in_array($PAGE.modulo, array('libreta'))}active{/if} treeview">
						<a href="#">
							<span>Tienda</span> <i class="fa fa-angle-left pull-right"></i>
						</a>
						<ul class="treeview-menu">
							<li {if $PAGE.modulo eq 'libreta'}class="active"{/if}><a href="libreta"><i class="fa fa-balance-scale"></i> Libreta de ventas</a></li>
						</ul>
					</li>
					{/if}
				</ul>
